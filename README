<h1>PGPT - the PhoneGap Performance Tester</h1>
...
<ul>
<li> Can an HTML/Javascript PhoneGa app create smooth scrolling performance at native speeds?
<li> Which is better: CSS transforms vs. manual handling of DOM (Image) objects on various devices, and by how much?
<li> How do various properties of a frame impact framerate, such as:
<ul>
<li>number of sprites
<li>size of sprites
<li>overdraw
<li>opacity
<li>movement
<li>memory management (creation of new particles, etc.)
</ul>
</ul>